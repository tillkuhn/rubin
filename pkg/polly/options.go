...
func (o Options) String() string {
	return fmt.Sprintf("brokers=%s defaultGroupID=%s hasKey=%v hasSecret=%v", o.BootstrapServers, o.ConsumerGroupID, len(o.ConsumerAPIKey) > 0, len(o.ConsumerAPISecret) > 0)
}
